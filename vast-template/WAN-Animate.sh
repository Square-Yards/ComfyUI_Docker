...
UNET_MODELS=(
    "https://huggingface.co/QuantStack/Wan2.2-Animate-14B-GGUF/resolve/main/Wan2.2-Animate-14B-Q8_0.gguf"
)
...
function provisioning_download_models() {
    ...
    provisioning_get_models "${COMFYUI_DIR}/models/clip_vision" "${CLIP_VISION_MODELS[@]}"
}
